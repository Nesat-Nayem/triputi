          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between mb-3">
                ...
                >
                  <i class="mdi mdi-plus btn-icon-prepend"></i> Add City /
                  Area
                </button>
              </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        >
                         <a href="/admin/create-areas-edit/{{$val->id}}"      type="submit"
                          ...
                          <a href="/admin/areas-delete/{{ $val->id }}">
                            <button
                              type="button"

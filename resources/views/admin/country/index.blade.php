...
<div class="main-panel">
    <div class="content">
      <div class="page-inner">
        ...
        >
          ...
          <form action="/admin/new-country" class="w-100" method="post">
            @csrf
  ...
  <script>
    function editvalue(id){
        $.ajax({
    url: '/admin/get-country/'+id, // Laravel route

          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="col-lg-12">
                    <div class="mb-3">
                        <label for="simpleinput" class="form-label mb-2 text-dark">Gallery image</label>
                        <input type="file" id="simpleinput" name="image"
                            ...
                            <div class="text-danger mt-2">{{ $message }}</div>
                              ...
                              <img src="{{ url('') }}/uploads/{{ $gallery->image }}" class="img-thumbnail" width="100" height="100" alt="">
                              @endif
                    </div>
                </div>
                 </div>

    ...
    <div class="content">
      <div class="page-inner">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-dark" href="/admin/create-banner" role="button">Add</a>
        </div>
        <div class="card-body">
            <table id="fixed-header-datatable"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->status == "Y")
                            <a href="/admin/banners-status/{{$item->id}}" class="btn btn-primary">Y</a>
                            @else
                                <a href="/admin/banners-status/{{$item->id}}" class="btn btn-danger">N</a>
                            @endif
                        </td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure !')"
                                href="{{ route('banners_delete', ['table' => ' banners', 'id' => $item->id, 'image' => $image]) }}"
                                class="text-danger">

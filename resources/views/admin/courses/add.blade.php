          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="card-title d-inline-block">Courses Add +</div>
              </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    >
                      ...
                      <div class="py-3">
                        <h5 class="bg-dark text-white py-3 px-3">Courses For Doctors</h5>
                    </div>
                 <div class="row">
                ...
                <div class="col-lg-12">
                 ...
                 <div class="py-3">
                    <h5 class="bg-dark text-white py-3 px-3">Courses For Beauticians</h5>
                </div>
                 <div class="">
                    <div class="mb-3">
                        <label for="simpleinput" class="form-label mb-2 text-dark">Title</label>

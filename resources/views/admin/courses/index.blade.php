    ...
    <div class="content">
      <div class="page-inner">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-dark" href="/admin/create-course" role="button">Add</a>
        </div>
        <div class="card-body">
            <table id="fixed-header-datatable"
                ...
                <thead>
                    <tr>
                        <th>S/o</th>
                        <th>title-Courses For Beauticians</th>
                        <th>title-Courses For Beauticians</th>
                        <th></th>
                        <th>Status</th>
                        <th>Action</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->status == "Y")
                            <a href="/admin/change-status-course/{{$item->id}}" class="btn btn-primary">Y</a>
                            @else
                                <a href="/admin/change-status-course/{{$item->id}}" class="btn btn-danger">N</a>
                            @endif
                        </td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure !')"
                                href="{{ route('deleterownew', ['table' => 'courses', 'id' => $item->id, 'image' => $image]) }}"
                                class="text-danger">
                            ...
                            <a href="/admin/edit-course/{{ $item->id }}" class="text-primary">
                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path

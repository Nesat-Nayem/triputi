          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label for="category" class="form-label text-dark">Select Category</label>
                ...
                <div class="">
                    <div class="mb-3">
                        ...
                        <input type="text" id="simpleinput" name="video"
                            value="<?=$service->video ?>" class="form-control">
                            @error('video')
                            <div class="mt-2 text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="summernote" name="description" rows="3"><?= $service->description?></textarea>
                                @error('description')
                                <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <img src="{{ url('') }}/Service-image/{{ $service->icon }}" class="img-thumbnail" width="100" height="100" alt="">
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <img src="{{ url('') }}/Service-image/{{ $service->image }}" class="img-thumbnail" width="100" height="100" alt="">
                                @endif
                            </div>
                        </div>
                        </div>

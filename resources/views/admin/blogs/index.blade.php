    ...
    <div class="content">
      <div class="page-inner">
        <div class="page-header">
          <h4 class="page-title">Blogs Deatials</h4>
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-white" href="/admin/create-blog" role="button">Add</a>
        </div>
        <div class="card-body">
            <table id="fixed-header-datatable"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ url('') }}/uploads/<?=$item->image ?>" width="50" class="border-radius"  alt="">
                        </td>

                        <td>
                            <img src="{{ url('') }}/uploads/<?=$item->banner ?>" width="200" height="100" alt="">
                        </td>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure !')"
                                href="{{ route('blogsdelete', ['table' => 'blogs', 'id' => $item->id, 'image' => $image]) }}"
                                class="text-danger">
                            ...
                            <a href="/admin/blogs-edit/{{ $item->id }}" class="text-primary">
                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path

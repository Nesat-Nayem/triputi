    ...
    <div class="content">
      <div class="page-inner">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-dark" href="/admin/create-packages" role="button">Add</a>
        </div>
        <div class="card-body">
            <table id="fixed-header-datatable"
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($item->status == "Y")
                            <a href="/admin/packages-change-status/{{$item->id}}" class="btn btn-primary">Y</a>
                            @else
                                <a href="/admin/packages-change-status/{{$item->id}}" class="btn btn-danger">N</a>
                            @endif
                        </td>
                        ...
                        <td>
                            ...
                            <a href="/admin/packages-update/{{ $item->id }}" class="text-primary">
                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path

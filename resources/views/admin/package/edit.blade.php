          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" id="simpleinput" name="title"
                            value="<?=$package->title ?>" class="form-control">
                            @error('title')
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        <label for="simpleinput" class="form-label mb-2 text-dark">sub Title</label>
                        <input type="text" id="simpleinput" name="sub_title"
                            value="<?=$package->sub_title ?>" class="form-control">
                            @error('sub_title')
                            <div class="mt-2 text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                 ...
                 <div class="">
                    <div class="mb-3">
                        ...
                        <img src="{{ url('') }}/uploads/{{ $package->image }}" class="img-thumbnail" width="100" height="100" alt="">
                        @endif
                    </div>
                </div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="summernote" name="desc" rows="3"><?=$package->desc ?></textarea>
                                @error('desc')

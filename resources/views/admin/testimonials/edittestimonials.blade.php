                  ...
                  <div class="col-lg-12">
                    ...
                    >
                     ...
                     <div class="row">
                      <div class="col-lg-6">
                        <div class="mb-3">
                            <label for="simpleinput" class="form-label mb-2 text-dark">Name</label>
                    ...
                    <div class="col-lg-6">
                      <div class="mb-3">
                          <label for="simpleinput" class="form-label mb-2 text-dark">Destination</label>
                          <input type="text" id="simpleinput" name="destination"
                              value="<?=$row->destination ?>" class="form-control">
                              @error('destination')
                       <div class="text-danger mt-2">{{ $message }}</div>
                       @enderror
                      </div>
                        ...
                        <div class="">
                            <div class="mb-3"> 
                             ...
                             @enderror
                             @if(isset($row->image))
                             <img src="{{ url('') }}/uploads/{{ $row->image }}" class="img-thumbnail" width="100" height="100" alt="">
                             @endif
                            </div>
                        </div>
                      ...
                      <div class="col-12 mt-3">
                        <button
                          type="submit"
                          id="PropertySubmit"
                          class="btn btn-success px-4">Save
                        </button>
                      </div>

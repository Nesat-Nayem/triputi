                    ...
                    >
                      ...
                      <div id="sliders"></div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label mb-2">Name</label>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label mb-2">Phone</label>
                                    <input type="number" id="simpleinput" name="phone"
                                        value="<?=$team->phone?>" class="form-control">
                                        @error('phone')
                                 <div class="text-danger mt-2">{{ $message }}</div>
                                 @enderror
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label mb-2">Email</label>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label mb-2">Designation</label>
                                <input type="text" id="simpleinput" name="sub_title"
                                    value="<?=$team->sub_title ?>" class="form-control">
                                    @error('sub_title')
                             <div class="text-danger mt-2">{{ $message }}</div>
                             @enderror
                            </div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="simpleinput" name="description" rows="3"><?=$team->description ?></textarea>
                                @error('desc')
                                <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label mb-2">Address</label>
                                <input type="text" id="simpleinput" name="address"
                                    value="<?=$team->address ?>" class="form-control">
                                    @error('address')
                             <div class="text-danger mt-2">{{ $message }}</div>
                             @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label mb-2">Facebook</label>
                                    <input type="text" id="simpleinput" name="facebook"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label mb-2">Twitter</label>
                                    <input type="text" id="simpleinput" name="twitter"
                           ...
                           <div class="">
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label mb-2">Instagram</label>
                                <input type="text" id="simpleinput" name="instagram"
                                    value="<?=$team->instagram ?>" class="form-control">
                                    @error('instagram')
                             <div class="text-danger mt-2">{{ $message }}</div>
                             @enderror
                            </div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                <label for="simpleinput" class="form-label mb-2">image</label>
                             ...
                             <img src="{{ url('/team-image') }}/{{ $team->image }}" class="img-thumbnail" width="100" height="100" alt="">
                             @endif
                            </div>
                        </div>

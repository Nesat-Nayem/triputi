    ...
    <div class="content">
      <div class="page-inner">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="card-title mb-0 text-dark">Data Lists</h5>
            {{-- <a class="btn btn-white" href="/admin/create-Contact Enquiry" role="button">Add</a> --}}
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure !')"
                                href="{{ route('appointment-delete', ['table' => 'appointment', 'id' => $item->id, 'image' => $image]) }}"
                                class="text-danger">
...
{{-- 
                            <a href="/admin/edit-Contact Enquiry/{{ $item->id }}" class="text-primary">
                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path

    ...
    <div class="content">
      <div class="page-inner">
        <div class="page-header">
          <h4 class="page-title">Add Poperty</h4>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="card-title d-inline-block">Add Porperty {{ $title }}</div>
              </div>
                      ...
                      <div class="col-lg-4">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea name="property_description" id="summernote" class="form-control" cols="30" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <textarea name="additional_description" id="additional_description" class="form-control" cols="30" rows="3"></textarea>
                            </div>
                        </div>

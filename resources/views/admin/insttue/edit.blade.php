          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="card-title d-inline-block">institute</div>
              </div>
                  ...
                  <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" id="simpleinput" name="title"
                            value="<?=$insttue->title ?>" class="form-control">
                            @error('title')
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="file" id="simpleinput" name="icon"
                            ...
                            <div class="mt-2 text-danger">{{ $message }}</div>
                        @enderror
                        @if(isset($insttue->icon))
                             <img src="{{ url('') }}/uploads/{{ $insttue->icon }}" class="img-thumbnail" width="100" height="100" alt="">
                             @endif
                    </div>
                </div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="summernote" name="desc" rows="3"><?=$insttue->desc ?></textarea>
                                @error('desc')

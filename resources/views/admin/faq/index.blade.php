    ...
    <div class="content">
      <div class="page-inner">
        ...
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a class="btn btn-white" href="/admin/create-faq" role="button">Add</a>
        </div>
        <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a onclick="return confirm('Are you sure !')"
                                href="{{ route('faq-delete', ['table' => 'banners', 'id' => $item->id, 'image' => $image]) }}"
                                class="text-danger">
                            ...
                            <a href="/admin/edit-faq/{{ $item->id }}" class="text-primary">
                                <svg width="20" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor">
                                    <path

      ...
      <div class="row">
        <div class="col-md-12">
          <div class="row">
            ...
            >
              <a href="/admin/bookin-list" style="width: 100%">
                <div
                  class="card"
                  style="
                    background: #e9f3f1;
                ...
                >
                  <div class="card-body text-center">
                    ...
                    <h2 class="mb-4 font-weight-bold">{{$todayBookings}}</h2>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div
              ...
              <a href="/admin/bookin-list" style="width: 100%">
                ...
                >
                  <div class="card-body text-center">
                    <h5 class="mb-2 font-weight-normal">today's Bookings</h5>
                    <h2 class="mb-4 font-weight-bold">{{$todayBookings}}</h2>
                  </div>
                </div>
              </a>
            ...
            <div
              class="col-xl-3 col-lg-6 col-sm-6 grid-margin stretch-card"
            >
              <a href="/admin/reports-list" style="width: 100%">
                <div
                  class="card"
                  style="
                    background: #eafaff;
                ...
                >
                  <div class="card-body text-center">
                    <h5 class="mb-2 font-weight-normal">today's Reports</h5>
            ...
            >
              <a href="/admin/reports-list" style="width: 100%">
                ...
                >
                  <div class="card-body text-center">
                    <h5 class="mb-2 font-weight-normal">monthly Reports</h5>
                    <h2 class="mb-4 font-weight-bold">{{$monthlyBookings}}</h2>
                  </div>
                </div>
              </a>
            </div>

          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <div class="card-title d-inline-block">Privacy Policy</div>
              </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    >
                      ...
                      <div id="sliders"></div>
                        ...
                        <div class="">
                            <div class="mb-3">
                                <label for="summernote" class="form-label mb-2">Privacy Policy</label>
                                <textarea class="form-control" id="summernote" name="privacy_policy" rows="3"><?=$data->info_one?></textarea>
                                @error('desc')
